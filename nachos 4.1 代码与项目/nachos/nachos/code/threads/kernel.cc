...
void
Kernel::threadStatus() {
	currentThread->PrintTest();	
}
void
Kernel::synchtest() {
    currentThread->synchTest(); 
}

void
Kernel::synchrwtest() {
    currentThread->synchrwTest(); 
}
void
Kernel::synchbrtest(int barriern)
{
    
    currentThread->synchbrTest(barriern);
}
//----------------------------------------------------------------------
// Kernel::ConsoleTest
