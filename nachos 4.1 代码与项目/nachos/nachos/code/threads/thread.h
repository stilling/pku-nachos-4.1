...
class Thread {
  ...
  public:
    ...
    void PrintTest();     //print status test
    void Print();     //print status
    void ReadyListPrint(); 
    void SelfTest();		// test whether thread impl is working
    void LimitTest();
	void threadtest();      //Test threadsLimit
    void synchrwTest();
    void synchbrTest(int n);
  ...
  private:
	...
	int priority;
    int runtime;
	//add data members and functions for newly added data members
	private:
	 int UserID;
	 int ThreadID;
	public:
